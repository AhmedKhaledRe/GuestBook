    ...
    <div className='col-12 mb-2'>
      <Link className='messege-detail-link' to="/messeges/manage">
        <section id='messegeDetails'>
            <div className='details-section border border-primary p-2 rounded'>
              <div className='row'>
                <div className='col-12'>
                  <div>
                    <div className="messege-owner">
                      <img className="m-3" src="https://api.adorable.io/avatars/285/abott@adorable.png" alt="owner"/>
                      <span className='mr-0 font-weight-bold'>{messege.user && messege.user.username}</span>
                    </div>
                    <div>
                    <h4 className='m-2 font-weight-normal'>{messege.description}</h4>
                    </div>
                    <div className='m-2 pt-5 flow-text grey-text text-darken-1'>
